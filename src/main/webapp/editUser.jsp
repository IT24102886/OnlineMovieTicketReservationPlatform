...
<html>
<head>
    <title>Edit User | QuickFlicks</title>
    <meta charset="UTF-8">
            ...
            <form action="EditUserServlet" method="post" id="editUserForm">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="email" class="form-control" id="email" name="email" value="${user.email}" required placeholder="your@email.com">
                    </div>
                </div>
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="contactNumber" name="contactNumber" value="${user.contactNumber}" required placeholder="Your contact number">
                    </div>
                </div>
                <div class="mb-3">
